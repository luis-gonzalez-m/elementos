...
Fuentes Rodriguez (2017) argumenta que el lenguaje no se limita a un conjunto de oraciones articuladas alrededor del verbo y sus complementos, sino que transiende a un mensaje real donde el nucleo (o noyau) y el contexto comunicativo se rigen por criterios entonativos, informativos y pragmaticos que aseguran una interpretación efectiva. La macrosintaxis y la microsintaxis se complementan entre si, aportando un marco de referencia para el analisis estructural de la gramatica y la semantica en unidades superiores a la oración (como nucleos y marcos), partiendo de oraciones simples con reglas internas, concordancia y dependencias regidas por el verbo.
La relación entre biología y lingüística aplicada se evidencia de manera que los procesos comunicativos humanos no solo corresponden a necesidades sociales, sino también a exigencias prácticas. Este es el caso de la lingüística de la biología; que fue necesaria para abarcar un problema: el lenguaje que se aplicaría a conceptos, textos y descubrimientos, etc.    
